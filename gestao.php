...
<head>
  ...
  <script type="text/javascript" src="js/jquery-3.6.1.min.js"></script>
        ...
        $("#salvar_alt").click(function(){
	                ...
	                var cargo = $("#alterar_cargo").val();

	                $.ajax({
	                url: "php/script_updateGestao.php",
	                type: "POST",
	                data: "codigo="+codigo+"&nome="+nome+"&cargo="+cargo,
	                dataType: "html"
        ...
        <section class="gestao">
              <div class="gestao-container">
                <div class="gestao-users">
                  ...
                  <button class="alterar" data-bs-toggle="modal" data-bs-target="#editModal" cod="<?php echo $row['cd_membro'];?>" nome="<?php echo $row['nm_membro'];?>" cargo="<?php echo $row['ds_cargo'];?>" ><i
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          ...
          <form>
            ...
            <div class="row mb-3">
              ...
              <div class="col">
                ...
                <input type="text" class="form-control" id="alterar_cargo">
              </div>
            </div>
          </form>
        </div>
        ...
        <div class="modal-footer">
          <button id="salvar_alt" type="button" class="btn btn-roxo" onclick="window.location.reload()">Salvar Alterações</button>
