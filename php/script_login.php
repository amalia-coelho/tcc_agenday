...
try {
    ...
    if ($usuario) {
        if ($usuario['ds_senha'] == $_POST['senha']) {
            ...
            echo '<div class="alert" style="background-color: #DCEED7; border-left: 8px solid #9EB0A0; animation: none;"><i class="bi bi-check-lg "style="color: #9EB0A0";"></i><span class="msg" style="color: #9EB0A0;font-size: 17px">Credencias Corretas!</span></div><script>$(".spinner-border").show();</script>';
        } else {
