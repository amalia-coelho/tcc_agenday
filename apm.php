        ...
        <div class="apm-group">
          ...
          <div class="apm-card">
            ...
            <button data-bs-toggle="modal" data-bs-target="#editModal"
              style="background: none; padding: 0; width: 0;"><i class="bi bi-pencil-square edit-icon"></i></button>
            <i class="bi bi-trash-fill delete-icon"></i>
            <div class="card-info">
              <div class="card-text">
                <p class="card-title">Camiseta </p>
          ...
          <div class="apm-card">
            ...
            <div class="card-info">
              <div class="card-text">
                <p class="card-title">Guilherme </p>
                <p class="card-sub">Kkkkkkkkkkkk</p>
              </div>
              <div class="price">
                <a href="#" class="btn btn-secondary">R$ 5,00</a>
              </div>
            </div>
          </div>
          <!-- fim card -->
