			...
			<section class="entrar" id="entrar">
				<div class="login-container">
					<div class="login-content">
						<!-- titulo -->
						<div class="titulo">
							<h1 class="h1"><label class="log-success">Verificação</label> em <br><span class="resp">Duas Etapas</span></h1>
							<small><a href="#">Verifique seu e-mail e abaixo digite o código de verificação que foi enviado no mesmo</a></small>
						</div>
						<!-- fim do titulo -->
						
						<!-- começa os input -->
						<div class="form-group custom-spacing pass inputs-container">
							<input type="number" class="form-control text-center" id="codigo1" min="0" max="9" required autofocus>
							<input type="number" class="form-control text-center" id="codigo2" min="0" max="9" required>
							<input type="number" class="form-control text-center" id="codigo3" min="0" max="9" required>
							<input type="number" class="form-control text-center" id="codigo4" min="0" max="9" required>
							<input type="number" class="form-control text-center" id="codigo5" min="0" max="9" required>
						</div>
						<small class="cod"><a href="#">Reenviar Código</a></small>
						<!-- fim dos input -->
						<div class="revealbtn">
							<a class="ent" href="#" data-bs-toggle="modal" data-bs-target="#editModal">Verificar</a>
